...
::: {style="text-align: left; font-size: 50%"}
[Original:]{style="color:red;"} Exposure to neuromodulatory chemicals in the polychaete marine worm, Capitella teleta, has been used to assess changes in locomotory behaviour in adult and juvenile life stages.Worms were exposed to nicotine, fluoxetine, apomorphine, and phenobarbital and had their
...
You can share your data in [specialized or generalist]{style="text-decoration: underline;"} repositores like The [Federated Research Data Repository (FRDR)](https://www.frdr-dfdr.ca/repo/) or [Borealis](https://borealisdata.ca/).
:::
...
## Borealist network in Canada{.center}
